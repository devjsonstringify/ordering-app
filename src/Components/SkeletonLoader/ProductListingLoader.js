...
// import local files
import SearchProductLoader from './SearchBarLoader';

export default function ProductListingLoader(props) {
  const [size] = useState({ width: '100%', height: '100%' });
  return (
    <>
      <SearchProductLoader />
      <ContentLoader viewBox="0 0 900 507" height={size.height} width={size.width} {...props}>
        <rect x="3%" y="20" rx="0" ry="0" width="130" height="23" />
        <rect x="82%" y="20" rx="0" ry="0" width="130" height="23" />
